...
n_points_options = [25, 111]
m_rate_options = [0.0001, 1111]
...
selected_configs = [(0.005, 2, 111, 1111, 3), (0.02,2,111,1111,3), (0.005,2,111,0.0001,3)]

#selected_configs[0] = (0.0025, 1, 111, 111, 3)

# Define the file path
file_path = f"./FINALRD/{dataset}/FINAL/selected_configs.txt"
...
for rd_number in range(len(selected_configs)):
    for i in range(5):  
        final_fitness = main(dataset, selected_configs[rd_number][0], selected_configs[rd_number][1], selected_configs[rd_number][2], selected_configs[rd_number][3], selected_configs[rd_number][4], 1000, rd_number = 0, config_number = rd_number, iteration = i) 
